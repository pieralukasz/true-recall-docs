...
- [FSRS Algorithm](/scheduling/fsrs-algorithm/) — how FSRS works and compares to older algorithms
- [FSRS Settings](/configuration/fsrs-settings/) — configure weights and retention targets
- [Presets & Optimization](/scheduling/presets/) — scheduling profiles and parameter optimization
