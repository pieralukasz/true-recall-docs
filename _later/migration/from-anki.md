...
Imported and native cards coexist in the same system — all use FSRS scheduling. Create new cards with the [Selection Toolbar](/views/selection-toolbar/) or by writing [block format](/creation/creating-flashcards/#block-format) in your notes.
